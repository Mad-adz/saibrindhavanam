    ...
    <div className="relative">
      ...
      {/* <section className="mt-[30rem] bg-amber-50 py-10">
        <div className="container mx-auto h-full px-4 sm:px-6 md:px-16 lg:px-20 xl:px-24">
          {orphanagePageContent.map((value,index) => (
            <div key={value.id}>
              {value.hasImage ? (
                <>
          ...
          <div>
            ...
            <p className="text-md text-zinc-700 leading-relaxed mb-4">
              Together, we can provide hope, love, and opportunity to orphaned
              children and ensure they have a bright future ahead. Your support
              can make a profound impact on the lives of vulnerable children and
              contribute to building a compassionate and inclusive society.
            </p>
            <p className="text-md text-zinc-700 leading-relaxed mb-4">
              For more information on our Orphanage Sponsorship program or to
              contribute, please contact us.
            </p>
            <p className="text-md text-zinc-700 leading-relaxed mb-4">
              Thank you for partnering with Shri Sai Brindhavanam Foundation in
              our mission to support orphaned and vulnerable children in need!
            </p>
          </div>
        </div>
      </section> */}
