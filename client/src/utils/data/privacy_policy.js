export const ppContent = {
  privacyPolicy: [
    ...
    {
      id: 5,
      title: "Collection of Personal DataSecurity Precautions",
      description:
  ...
  refund_and_cancellation: {
    ...
    details: [
      ...
      "SHRI SAIBRINDHAVANAM FOUNDATION does not accept cancellation requests for perishable items like flowers, eatables, etc. However, the refund / replacement can be made if the user establishes that the quality of the product delivered is not good.",
      ...
      "In case of any refunds approved by SHRI SAIBRINDHAVANAM FOUNDATION, it will take 3 days for the refund to be processed to you.",
    ],
  },
};
