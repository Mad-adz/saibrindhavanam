export const tcContent = {
  introduction: {
    ...
    details: [
      ...
      "This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name https://saibrindhavanam.com ('Website'), including the related mobile site and mobile application (hereinafter referred to as 'Platform').",
      "The Platform is owned by SHRI SAIBRINDHAVANAM FOUNDATION, a company incorporated under the Companies Act, 1956 with its registered office at Flat 1A,Block1,2A,Radhakrishnan Salai ,Chennai ,India (hereinafter referred to as ?Platform Owner?, 'we', 'us', 'our')..",
